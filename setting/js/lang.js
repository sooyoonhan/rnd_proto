...
function getLang(langFolder,callBack,isJson)
{
	...
	//var path = "setting/lang/"+langFolder+"/"; //언어파일 경로 설정
	//var type = sessionStorage.getItem('langType') !== null ? sessionStorage.getItem('langType') : 'kor';
	var langName = path + "/" + langFolder + "/lang.json"; //최종 호출 경로 설정
